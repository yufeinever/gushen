...
- 从现在开始，本项目默认在 T1000 设备上进行远程开发，本地 `D:\\gushen` 仅作参考，不直接更新项目文件。远程项目路径：`/home/yu/projects/gushen`。
