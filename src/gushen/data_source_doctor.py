...
def build_checks() -> list[DataSourceCheck]:
    ...
    return [
        ...
        DataSourceCheck(
            "ths_industry_board_names",
            "sector_theme",
            "AKShare/THS",
            "stock_board_industry_name_ths",
            "THS industry board universe",
            True,
            False,
            lambda: len(ak.stock_board_industry_name_ths()),
        ),
        DataSourceCheck(
            ...
            "THS industry board strength and fund-flow summary",
            True,
            False,
            lambda: len(ak.stock_board_industry_summary_ths()),
        ),
        DataSourceCheck(
            "ths_concept_board_names",
            "sector_theme",
            "AKShare/THS",
            "stock_board_concept_name_ths",
            "THS concept board universe",
            True,
            False,
            lambda: len(ak.stock_board_concept_name_ths()),
        ),
        DataSourceCheck(
            "ths_concept_summary",
            "sector_theme",
            ...
            "THS concept event summary",
            True,
            False,
            lambda: len(ak.stock_board_concept_summary_ths()),
        ),
        DataSourceCheck(
            "sw_second_industry",
            "sector_theme",
            ...
            "Shenwan second-level industry taxonomy and valuation",
            True,
            False,
            lambda: len(ak.sw_index_second_info()),
        ),
        DataSourceCheck(
            "sw_third_industry",
            "sector_theme",
            "AKShare/SW",
            "sw_index_third_info",
            "Shenwan third-level industry taxonomy and valuation",
            True,
            False,
            lambda: len(ak.sw_index_third_info()),
        ),
        DataSourceCheck(
            "sina_sector_detail_sample",
            "sector_theme",
            "AKShare/Sina",
            "stock_sector_detail",
            "Sina sector constituent sample by known label",
            True,
            False,
            lambda: len(ak.stock_sector_detail(sector="new_blhy")),
        ),
        DataSourceCheck(
            "cninfo_industry_category",
            "sector_theme",
            "AKShare/CNInfo",
            "stock_industry_category_cninfo",
            "CNInfo industry category taxonomy",
            True,
            False,
            lambda: len(ak.stock_industry_category_cninfo(symbol="\u5de8\u6f6e\u884c\u4e1a\u5206\u7c7b\u6807\u51c6")),
        ),
        DataSourceCheck(
            "main_fund_flow",
            "fund_flow",
        ...
        DataSourceCheck(
            ...
            "THS industry fund-flow ranking",
            True,
            False,
            lambda: len(ak.stock_fund_flow_industry(symbol="\u5373\u65f6")),
        ),
        DataSourceCheck(
            ...
            "THS concept fund-flow ranking",
            True,
            False,
            lambda: len(ak.stock_fund_flow_concept(symbol="\u5373\u65f6")),
        ),
        DataSourceCheck(
            "hsgt_flow",
            "fund_flow",
